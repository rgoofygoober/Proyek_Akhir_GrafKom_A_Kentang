...
int main(int argc, char **argv)
{
    ...
    loadTexture("Resource\\bed_sheet.bmp", 0);  //Give full path of image else it will not work
    loadTexture("Resource\\tembok.bmp", 1);
    loadTexture("Resource\\plafon_1.bmp", 2);
    loadTexture("Resource\\lantai.bmp", 3);
    loadTexture("Resource\\table.bmp", 4);
    loadTexture("Resource\\lemari.bmp", 5);
    loadTexture("Resource\\tv.bmp", 6);
